  ...
  return (
    <footer className="bg-slate-950 text-white pt-24 pb-12 border-t-8 border-primary">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
          <p className="text-slate-500 text-xs font-medium">
            © 2026 Sorocua Travel Agency. Todos los derechos reservados.
          </p>
